...
import com.li.elasticsearchdemo.entity.Person;
import com.li.elasticsearchdemo.entity.Post;
import com.li.elasticsearchdemo.repository.PostRepository;
...
public class Init {
    ...
    public void init() {
        ...
        for (int i = 0; i < 40; i++) {
            ...
            person.setAge(rand.nextInt(60) + 20);
            person.setName(this.getName());
            person.setHouseNum(rand.nextInt(2000) + 1000);
    ...
    private String getName() {
        ...
        for (int i = 0; i < 6; i++) {
            nameBuilder.append(charList.get(rand.nextInt(25) + 1));
        }
